...
public class ViewHolder {
	...
	public ViewHolder setImageByUrl(int viewId, String url, Context context) {
		...
		ImageLoad.loadImgDefault(context, (ImageView) getView(viewId), url);
	 ...
	 * @return
	 */
	public ViewHolder setImageByUrl(int viewId, String url, Context context, int drawId) {
		ImageLoad.loadImgDefault(context,(ImageView) getView(viewId), url, drawId);
		return this;
	}
