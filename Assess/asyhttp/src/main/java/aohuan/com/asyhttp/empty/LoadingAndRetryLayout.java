package aohuan.com.asyhttp.empty;
...
public class LoadingAndRetryLayout extends FrameLayout
{
    ...
    private View mCurrentVisiableView= null;//加载框出现之前的view
    ...
    public void closeLoading(){
        ...
        if (mCurrentVisiableView != null) {
            showView(mCurrentVisiableView);
        }else{
            showView(mContentView);
        }
